  ...
  <header className='bg-white w-[100%]'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
          ...
          <Aside onClick={handleClick}/>
            ...
            <div className='bg-green-100 shadow-sm text-base p-4 mt-5 mb-20'>
              ...
              inherit the dimension of your device screen size and possibly mar the positioning on development stage.</p>
